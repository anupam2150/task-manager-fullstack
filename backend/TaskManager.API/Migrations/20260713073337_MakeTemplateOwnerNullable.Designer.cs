...
namespace TaskManager.API.Migrations
{
    ...
    [Migration("20260713073337_MakeTemplateOwnerNullable")]
    partial class MakeTemplateOwnerNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.API.Models.TaskItem", b =>
                {
                    ...
                    b.Property<bool>("RecurrenceSpawned")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TaskManager.API.Models.TaskTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("SubtaskTitles")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TaskManager.API.Models.TaskDependency", b =>
                {
                    b.HasOne("TaskManager.API.Models.TaskItem", "Blocked")
                        .WithMany("BlockedBy")
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TaskManager.API.Models.TaskItem", "Blocker")
                        .WithMany("Blocking")
