...
public record ProjectDto(int Id, string Name, string Description, DateTime CreatedAt, int OwnerId, int TaskCount = 0, int CompletedCount = 0, string? ShareToken = null, int InProgressCount = 0);
